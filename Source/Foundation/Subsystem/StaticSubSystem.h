...
#define TIAN_BEGIN_SUBSYSTEM_DECLARATION(GroupName, SubsystemName)             \
  class GroupName##SubsystemName##SubSystem;                                 \
  class GroupName##SubsystemName##SubSystem : public SubSystem             \
  {                                                                          \
  public:                                                                    \
...
#define TIAN_END_SUBSYSTEM_DECLARATION \
  }                                  \
...
public:                                                    \
  virtual const char* GetDependency(int32 iDep) override \
  {                                                        \
    const char* szDeps[] = {
...
#define TIAN_MAKE_SUBSYSTEM_STARTUP_FRIEND(GroupName, SubsystemName) friend class GroupName##SubsystemName##SubSystem;
